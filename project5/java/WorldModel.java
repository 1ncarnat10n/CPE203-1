...
final class WorldModel {
    ...
    private static final int SMITH_ACTION_PERIOD = 20;
    ...
    private static final int MINER_ANIMATION_PERIOD = 2;
    ...
    public Background getBackgroundCell(Point pos) {
        ...
        return new Background("null", new ArrayList<>());
    }
    ...
    // TODO: Make this a private method. Use tryAdd only!
    ...
    private boolean parseSmith(String[] properties,
        ...
        if (properties.length == SMITH_NUM_PROPERTIES) {
            ...
            Blacksmith blacksmith = new Blacksmith(properties[SMITH_ID],
                    pt, SMITH_ACTION_PERIOD, imageStore.getImageList(SMITH_KEY));
