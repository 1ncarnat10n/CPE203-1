...
public class TestCases {
    ...
    public void testCircleTranslate() {
        ...
        assertEquals(2, c.getCenter().y, DELTA);
    }
    ...
    public void testGetRectangleArea() {
        Rectangle r = new Rectangle(4.0, 3.0, new Point(0, 3), Color.BLACK);
    ...
    @Test
    public void testGetConvexPolygonArea() {
        Point[] pointList = {new Point(0, 0), new Point(1, 0), new Point(1, 1), new Point(0, 1)};
        ConvexPolygon poly = new ConvexPolygon(pointList, Color.BLACK);

        assertEquals(1.0, poly.getArea(), DELTA);
    }

    @Test
    public void testGetConvexPolygonPerimeter() {
        Point[] pointList = {new Point(0, 0), new Point(1, 0), new Point(1, 1), new Point(0, 1)};
        ConvexPolygon poly = new ConvexPolygon(pointList, Color.BLACK);

        assertEquals(4.0, poly.getPerimeter(), DELTA);
    }
