...
final class WorldModel {
    ...
    public Set<ActivitiedEntity> activitiedEntities;
    public Set<AnimatedEntity> animatedEntities;
    ...
    public WorldModel(int numRows, int numCols, Background defaultBackground) {
        ...
        this.activitiedEntities = new HashSet<>();
        this.animatedEntities = new HashSet<>();
    ...
    public void addEntity(Entity entity) {
        ...
        if (entity instanceof ActivitiedEntity) {
            ActivitiedEntity actE = (ActivitiedEntity)entity;
            activitiedEntities.add(actE);
        }
        if (entity instanceof  AnimatedEntity) {
            AnimatedEntity aniE = (AnimatedEntity)entity;
            animatedEntities.add(aniE);
        }
    }
